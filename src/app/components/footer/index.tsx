    ...
    <div className="footer_config">
      <Container>
        ...
        <Stack flexDirection={"row"} style={{ height: "250px" }}>
          <Stack className="info" flexDirection={"column"} data-aos="zoom-out-up">
            <Box>
              <img src={"/icons/Vector01.svg"} alt="" />
              <img src={"/icons/logo.svg"} alt="" />
            </Box>
            <Box className="main_text" data-aos="zoom-out-up">
                Be the first to hear about new product drops,
                insider news, exclusive offers, and more.
            </Box>
            <Stack className="contact_links" data-aos="zoom-out-up">
              <Box>
              ...
              <Box className={"card_types"} data-aos="zoom-out-up">
            ...
            <Stack className="parts" 
              ...
              <Box className="target" data-aos="zoom-out-up">
                  Home
                  Shop
                  Community
                  Orders
            ...
            <Stack className="find_us" data-aos="zoom-out-up">
              <Box className="find" data-aos="zoom-out-up">Contacts</Box>
              <Box className="divider"></Box>
                <Stack className="detailes" sx={{ mt: "29px"}} data-aos="zoom-out-up">
                  ...
                  <Box className="detail_second">Pepublic of Korea. Deagu Nam-gu</Box>
                    ...
                    <Stack className="detailes" 
                           sx={{ mt: "29px"}} 
                           data-aos="zoom-out-up">
                      <Box className="detail_first">
                        <img
                           src={"/footer/email-part-2-svgrepo-com.svg"}
                           style={{ marginTop: "10px" }} alt="" /></Box>
