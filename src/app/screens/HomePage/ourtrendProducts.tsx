          ...
          <Stack sx={{ mt: "43px" }} flexDirection={"row"}>
            <Box className="suit_box">
              <Stack
                className="suit_img"
                sx={{
                  backgroundImage: `url('/suits/-5017792296-NENT02E5-SS23-Sondrio---Cream-Cotton--Linen---Neo-Cut-Suit.jpg')`
                }}
              >
            ...
            <Box className="suit_box">
              <Stack
                className="suit_img"
                sx={{
                  backgroundImage: `url('/suits/10005-995-2--tt.jpg')`
                }}
              >
                <div className={"sale_suits"}>-25% SALE</div>
                <div className={"view_btn"} >
            ...
            <Box className="suit_box">
              <Stack
                className="suit_img"
                sx={{
                  backgroundImage: `url('/suits/SpierAndMackaySS22_Tobacco-Seersucker---Suit-HL-J064-1-1080-t.jpg')`
                }}
              >
                <div className={"sale_suits"}>-25% SALE</div>
                <div className={"view_btn"}>
